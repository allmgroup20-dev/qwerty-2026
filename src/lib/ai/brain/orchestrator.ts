...
export const CHAINS: Record<string, string[]> = {
  ...
  "psychology_objection": ["personality_classifier", "comm_style_identifier", "mask_detector", "task_separation_guide", "rapport_builder", "reframing_agent", "reciprocity_trigger", "authority_builder", "social_proof_amplifier"],
  "psychology_general": ["mood_detector", "rapport_builder", "empathy_expresser", "present_moment_guide", "task_separation_guide", "deep_rapport_agent"],
