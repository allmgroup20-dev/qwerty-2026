...
export default function AISettingsPage() {
  ...
  const getDeptAgents = (deptId: string): string[] => {
    const deptAgents: Record<string, string[]> = {
      ...
      negativity_detection: ["affiliate_trigger_detector", "recruitment_trigger_detector", "money_trigger_detector", "sentiment_negativity_scanner", "trust_barrier_identifier", "safe_wording_advisor", "cultural_sensitivity_checker", "negativity_insight_miner"],
