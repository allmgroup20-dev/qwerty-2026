...
const navTabs = [
  ...
  { href: "/company/three-tiers", en: "3 Tiers", bn: "৩ স্তর", icon: "👤" },
  { href: "/company/buyer-utility-map", en: "Utility", bn: "ইউটিলিটি", icon: "🛒" },
  ...
  { href: "/company/strategic-sequencing", en: "Seq.", bn: "সিকোয়েন্স", icon: "🔢" },
  { href: "/company/tipping-point", en: "Tipping", bn: "টিপিং", icon: "⚡" },
  { href: "/company/fair-process", en: "Fairness", bn: "ন্যায্যতা", icon: "⚖️" },
  { href: "/company/red-ocean-traps", en: "Traps", bn: "ফাঁদ", icon: "⚠️" },
