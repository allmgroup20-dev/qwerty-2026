  ...
  return (
    <section className="max-w-[820px] mx-auto mt-8 md:mt-10 px-3.5 md:px-5">
      <div className="rounded-[20px] p-6 md:p-7 text-center bg-[linear-gradient(135deg,rgba(29,78,216,.06),rgba(234,88,12,.10),rgba(29,78,216,.06))] border border-[#E2E8F0] shadow-lg">
        <h2 className="text-xl md:text-2xl font-black text-[#1E293B] mb-2 leading-tight">
          ৩০ সেকেন্ডেই শুরু করুন আপনার আয়ের যাত্রা!
        </h2>
        <p className="text-sm md:text-base font-semibold text-[#64748B] max-w-[650px] mx-auto mb-4 leading-relaxed">
          নিচে আপনার নাম-ফোন দিন, সাথে সাথেই সব কোর্স ও অ্যাক্সেস চলে আসবে!
        </p>

        <div className="flex flex-wrap gap-2 justify-center mb-4">
          <span className="px-3 py-1.5 rounded-full bg-[rgba(29,78,216,.1)] text-[#1D4ED8] text-[12px] font-extrabold">
        ...
        <div className="flex flex-wrap gap-2 justify-center mb-5">
          {chips.map((chip) => (
            <span key={chip} className="px-3 py-1.5 rounded-full bg-[rgba(29,78,216,.1)] text-[#1D4ED8] text-[11px] font-extrabold">
              {chip}
            </span>
          ))}
        </div>
