  ...
  return (
    <div className="rounded-2xl p-5 md:p-6 bg-gradient-to-br from-primary/5 to-primary/5 border border-primary/20">
      <div className="section-header">
        <div className="badge mx-auto mb-3">⚙️ {lang === "bn" ? "আয়ের সহজ ৩টি ধাপ" : "3 Simple Steps to Earn"}</div>
        <h3 className="text-lg md:text-xl font-black text-text">{lang === "bn" ? "আপনার আয়ের সহজ ৩টি উপায়:" : "Your 3-Step Earning Plan:"}</h3>
      </div>
