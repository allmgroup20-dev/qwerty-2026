...
export default function ProblemSolutionCards() {
  return (
    <section className="max-w-[1120px] mx-auto mt-6 md:mt-8 px-3.5 md:px-5">
      <div className="flex w-fit gap-2 px-4 py-2.5 mx-auto mb-4 rounded-full bg-primary/10 border border-primary/20 font-extrabold text-sm text-primary">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
        <div className="rounded-[20px] p-[18px_16px] md:p-[20px] bg-[linear-gradient(135deg,rgba(220,38,38,.04),rgba(220,38,38,.02))] border border-[rgba(220,38,38,.12)]">
          <h3 className="text-danger font-black text-base md:text-lg mb-3">❌ আজকের অনলাইন লার্নিং এর বড় বড় সমস্যা</h3>
          <ul className="list-none p-0 m-0 grid gap-2">
            {[
              ...
              <li key={item} className="flex gap-2.5 items-start text-sm font-bold text-text leading-[1.65]">
                <span className="w-6 h-6 rounded-full flex items-center justify-center bg-[rgba(220,38,38,.12)] text-danger font-black text-xs mt-0.5 shrink-0">⚠️</span>
                {item}
              </li>
            ))}
          </ul>
